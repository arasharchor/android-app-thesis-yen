...
// SOURCE: https://developer.android.com/guide/topics/ui/layout/listview.html

public class CursorListActivity extends ListActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            usedFragment = new CursorListFragment();
